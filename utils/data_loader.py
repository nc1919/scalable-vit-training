...
def get_data_loader(params, files_pattern, train, distributed=False, rank=0, world_size=1):
    ...
    if params.num_data_workers > 0:
        dataloader_kwargs["prefetch_factor"] = int(params.get("prefetch_factor", 4))
